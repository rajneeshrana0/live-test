...
const HeatIssue = () => {
  ...
  const handleToggleCompletion = () => {
    ...
    if (!completed) {
      ...
      const formattedDate = `${now.toLocaleDateString()} ${now.toLocaleTimeString([], options)}`;
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mt-8 grid grid-cols-1 gap-6">
        <div>
          ...
          <select
            id="lotNumber"
            className="mt-1 focus:ring-darkgray focus:border-darkgray block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
            value={selectedLot}
      ...
      <div className="mt-12 w-full">
        <div className="w-full mt-6 bg-white border-nav border-2 rounded-lg">
          <div className="flex ml-4 mt-4 justify-between items-center ">
            <div className="text-title font-bold">Heat Issue</div>
