          ...
          <div className="p-6 border-b border-gray-300">
            ...
            <div className="mt-6 bg-gray-200 rounded-lg p-6">
              ...
              <div className="flex flex-col w-64">
                <label htmlFor="qualities" className="text-lg mb-2">
                  Select Qualities:
                </label>
                <select
                  className="block appearance-none w-[300px] bg-white border border-gray-300 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline"
                  ...
                  onChange={(e) => {
                    ...
                    setSelectedQualities(selectedValues);
                  }}
                >
                  <option value="">Select Quality</option>
                  {qualities.map((quality) => (
                    <option key={quality._id} value={quality.name}>
                      {quality.name}
                    </option>
                  ))}
                </select>
                ...
                <div className="mt-4">
                  <strong>Selected Qualities:</strong>
                  <ul>
                    {selectedQualities.map((selectedQuality, index) => (
                      <li key={index}>{selectedQuality}</li>
                    ))}
                  </ul>
                </div>
              </div>
